...
CREATE TABLE `employee_assignment` (
  ...
  CONSTRAINT `employee_assignment_ibfk_1` FOREIGN KEY (`EmployeeID`) REFERENCES `employee` (`emp_no`),
  CONSTRAINT `employee_assignment_ibfk_3` FOREIGN KEY (`createdby`) REFERENCES `employee` (`emp_no`)
